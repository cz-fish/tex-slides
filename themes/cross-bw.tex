...
%\font\hhilitefont=csssi10 scaled\magstep1

\textfont

%%% barvy
\def\hilitecolor{0.5 0.5 0.5}
%\def\hhilitecolor{0.5 0.5 0.5}
\def\textcolor{0 0 0}
...
\special{psfile=themes/cross_title_bw.eps hoffset=-42 voffset=-272 llx=0 lly=0 urx=900 ury=675 clip rhi=3150 rwi=4200}
...
\def\slide#1{
% pozadi slajdu
\special{psfile=themes/cross_bw.eps hoffset=-42 voffset=-272 llx=0 lly=0 urx=900 ury=675 clip rhi=3150 rwi=4200}
\oldpageno=\pageno
\bgroup
% nadpis slajdu
\vbox to0pt{\vskip-21pt\hskip-22pt\titlefont{#1}\vfil}
