...
\def\hhilitecolor{0 0 0}
\def\textcolor{0.2 0.2 0.2}
...
\hbox{\hskip -12pt \vbox to\ht\bulletbox{\hsize=4.1mm\image{themes/atoms_bul_bw.eps}{3.2mm}\hfil\vfil}\box\bulletbox}}
...
\hbox{\hskip 20pt \vbox to\ht\bulletbox{\hsize=3.5mm\image{themes/atoms_bul_bw.eps}{2.5mm}\hfil\vfil}\box\bulletbox}}
...
\special{psfile=themes/atoms_title_bw.eps hoffset=-42 voffset=-272 llx=0 lly=0 urx=720 ury=540 clip rhi=3150 rwi=4200}
...
\def\slide#1{
% pozadi slajdu
\special{psfile=themes/atoms_bw.eps hoffset=-42 voffset=-272 llx=0 lly=0 urx=720 ury=540 clip rhi=3150 rwi=4200}
\oldpageno=\pageno
\bgroup
% nadpis slajdu
